...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    ParseNumbers: function() {
      var t1, n1, n2;
      t1 = document;
      n1 = t1.querySelector("#num1");
      n2 = t1.querySelector("#num2");
      return [H.Primitives_parseInt(J.get$value$x(n1), null, null), H.Primitives_parseInt(J.get$value$x(n2), null, null)];
    },
    main: [function() {
      var t1, t2;
      t1 = document;
      t2 = t1.querySelector("#num1").style;
      t2.width = "50px";
      t2 = t1.querySelector("#num2").style;
      t2.width = "50px";
      t2 = J.get$onClick$x(t1.querySelector("#add"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new E.main_closure(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onClick$x(t1.querySelector("#sub"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new E.main_closure0(), false, H.getTypeArgumentByIndex(t2, 0));
      t2 = J.get$onClick$x(t1.querySelector("#mult"));
      W._EventStreamSubscription$(t2._html$_target, t2._eventType, new E.main_closure1(), false, H.getTypeArgumentByIndex(t2, 0));
      t1 = J.get$onClick$x(t1.querySelector("#divide"));
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, new E.main_closure2(), false, H.getTypeArgumentByIndex(t1, 0));
    }, "call$0", "index__main$closure", 0, 0, 0],
    main_closure: {
      "^": "Closure:3;",
      call$1: function(e) {
        var numbers = E.ParseNumbers();
        J.setInnerHtml$1$x(document.querySelector("#result"), J.toString$0$(J.$add$ns(numbers[0], numbers[1])));
        return;
      }
    },
    main_closure0: {
      ...
      call$1: function(e) {
        var numbers = E.ParseNumbers();
        J.setInnerHtml$1$x(document.querySelector("#result"), J.toString$0$(J.$sub$n(numbers[0], numbers[1])));
        return;
      }
    },
    main_closure1: {
      ...
      call$1: function(e) {
        var numbers = E.ParseNumbers();
        J.setInnerHtml$1$x(document.querySelector("#result"), J.toString$0$(J.$mul$ns(numbers[0], numbers[1])));
        return;
      }
    },
    main_closure2: {
      "^": "Closure:3;",
      call$1: function(e) {
        var numbers, t1, t2, t3;
        numbers = E.ParseNumbers();
        ...
        if (typeof t3 !== "number")
          return H.iae(t3);
        J.setInnerHtml$1$x(t1, C.JSDouble_methods.toString$0(t2 / t3));
        return;
      }
    }
  }, 1]];
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, args: [W.MouseEvent]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Node, W.Node]}];
